...
<?php include("ini.php"); //include initalization file wich include connection to databse file , header, head, navbar ?>
			...
			<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">مواضيع ذات صله - رصيد امتحان</li>
				  </ol>
			</nav>
			<!--sloc exam section-->
			<section class="exam-section exam-details">
				<h1 class="text-center">رصيد امتحان exam credit</h1>
				<hr></hr>
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-8 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.4s">
							<p>
								قبل الجلوس للامتحان يقوم المركز بشراء رصيد امتحان ، علي ان لا يقل رصيد الإمتحان عن عدد الجالسين للإمتحان ، حيث يتم شراء الامتحان عن طريق ملئ فورم شراء رصيد الامتحان او شراء الرصيد عن طريق نظام ادارة الامتحانات 
								<a href="get-exam.php">اجراءات شراء امتحان</a>
							</p>
							<br>
							<br>
						...
						<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
							...
							<ul class="list-group">
							  ...
							  <li class="list-group-item active"><a href="exam-credit.php">شراء رصيد امتحان</a></li>
