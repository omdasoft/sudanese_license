<?php $pageTitle = "إجراءات اعتماد مركز امتحان"; ?>
<?php include("ini.php"); //include initalization file wich include connection to databse file , header, head, navbar ?>
			...
			<section class="approved-cnt wow fadeInDown" data-wow-offset="0" data-wow-delay="0.3s">
				...
				<p class="lead">
					...
					<ul>
						<li>
							استيفاء معايير مراكز الامتحان <a href="exam-criteria.php">من هنا</a>
							او(<a href="docs/exam.pdf" download>للتحميل pdf</a>)
						</li>
						<li>
							ملء استمارة اعتماد المراكز التدريبية(<a href="docs/form.doc" download>للتحميل word</a>)
