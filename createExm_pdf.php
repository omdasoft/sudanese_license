<?php  
 ...
 {  
      ...
      $sql = "SELECT * FROM basic_data WHERE exam_cnt = 1 order by cntID asc";  
 ...
 {  
    ...
    $content = '';  
    $content .= '  
      <h1 align="right">مراكز الامتحانات المعتمدة للرخصة السودانية لتشغيل الحاسوب</h1><br /> 
