<?php $pageTitle = "اجتياز الإختبارات"; ?>
<?php include("ini.php"); //include initalization file wich include connection to databse file , header, head, navbar ?>
			...
			<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">مواضيع ذات صله - اجتياز اللإختبارات</li>
				  </ol>
			</nav>
			<!--sloc exam section-->
			<section class="exam-section exam-details">
				<h1 class="text-center">اجتياز الإختبارات</h1>
				<hr></hr>
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-8 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.4s">
							<p>
								ليس من الضروري أن يلتزم المتدرب بترتيب معين لاختبارات الوحدات التدريبية السبع ، حيث بإمكانة اختيار أي وحدة من تلك الوحدات للتدريب عليها والتقدم للاختبار فيها وعند نجاحه في اجتاز هذه الوحدة يتقدم للاختبار في وحدة أخرى حتى يجتاز جميع الاختبارات ، كما يمكن للمتدرب أن يتقدم لإجراء الاختبارات في جميع الوحدات دفعة واحدة وفقاً لمعرفته ومهاراته .
							</p>
							<br>
							<br>
						...
						<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
							...
							<ul class="list-group">
							  ...
							  <li class="list-group-item active"><a href="pass-exam.php">اجتياز الاختبارات</a></li>
							  <li class="list-group-item"><a href="#">نظام ادارة الإمتحانات</a></li>
